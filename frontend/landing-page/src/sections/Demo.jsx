    ...
    <div className="min-h-screen bg-agentic-secondary/50 pt-28 pb-20 px-6 font-sans">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="bg-agentic-surface border border-agentic-text/10 rounded-2xl shadow-xl overflow-hidden grid grid-cols-1 md:grid-cols-12">
          ...
          <div className="md:col-span-5 bg-gradient-to-br from-slate-900 via-[#1b2a47] to-slate-950 p-8 flex flex-col justify-between text-white relative overflow-hidden min-h-[300px] md:min-h-[480px]">
            
            {/* Subtle Grid overlay */}
            <div className="absolute inset-0 bg-dashed-grid opacity-10 pointer-events-none" />
            
            {/* Absolute decorative gradient glow (non-AI/subtle) */}
            <div className="absolute top-12 left-12 w-32 h-32 rounded-full bg-agentic-primary/20 blur-3xl pointer-events-none" />
            
            <div className="relative z-10">
              <span className="px-3 py-1 text-[10px] font-semibold tracking-wider text-agentic-primary bg-agentic-primary/10 border border-agentic-primary/20 rounded-full uppercase">
                Under Development
              </span>
            </div>
            ...
            <div className="relative z-10 my-auto flex flex-col items-center justify-center py-6">
              <div className="relative w-28 h-28 flex items-center justify-center">
                ...
                <motion.div 
                  ...
                  className="absolute inset-2 rounded-full border border-dashed border-agentic-primary/40"
                />
                {/* Icon center */}
              ...
              <span className="text-xs text-white/50 font-mono mt-5 tracking-wide">interactive_demo.sh</span>
            </div>

            <div className="relative z-10 text-center md:text-left">
              <p className="text-[11px] text-white/40 font-mono">InfraX v1.0.0-rc1</p>
            </div>
          </div>
          ...
          <div className="md:col-span-7 p-8 md:p-12 flex flex-col justify-between bg-agentic-surface">
            <div>
              <h1 className="text-3xl md:text-4xl font-display font-medium tracking-tight text-gray-900 dark:text-white leading-tight">
                Product Demo Coming Soon
              </h1>
              
              <p className="text-sm text-gray-500 dark:text-white/70 mt-4 leading-relaxed font-sans">
              ...
              <div className="mt-8 pt-6 border-t border-agentic-text/5">
                <h3 className="text-xs font-semibold uppercase tracking-wider text-gray-400 dark:text-white/40 font-mono">
                  What you can expect
                </h3>
                <ul className="mt-4 space-y-3">
                  {expectations.map((item, idx) => (
                    <motion.li 
                      ...
                      className="flex items-center text-sm text-gray-600 dark:text-white/80 font-sans"
                    >
            ...
            <div className="mt-8 pt-6 border-t border-agentic-text/5">
                ...
                {!isSubmitted ? (
                  ...
                  >
                    <div className="relative">
                      <input 
                        ...
                        className={`w-full px-4 py-3 pl-11 bg-agentic-secondary border ${
                          error ? 'border-red-500' : 'border-agentic-text/10'
                      ...
                      />
                      <Mail className="absolute left-4 top-3.5 w-4 h-4 text-agentic-text/30" />
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 pt-2">
                      ...
                      <a
                        href="/"
                        className="px-6 py-3 border border-agentic-text/10 hover:border-agentic-text/20 text-agentic-text font-medium text-sm rounded-lg transition-colors flex items-center justify-center"
                      >
                        Back to Home
                      </a>
                    </div>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-white/60 mt-1 leading-relaxed">
                        We'll alert you the moment the interactive sandbox sandbox environments go live.
                      </p>
                      <a
                        href="/"
              ...
              <p className="text-xs text-gray-400 dark:text-white/40 text-center md:text-left mt-6 font-sans">
