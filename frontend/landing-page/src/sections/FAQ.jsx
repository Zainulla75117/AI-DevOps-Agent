  ...
  return (
    <section id="faq" className="py-24 relative overflow-hidden bg-agentic-secondary">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        >
          <div className="text-xs uppercase font-medium tracking-[0.2em] text-agentic-primary/80 mb-3">
            Knowledge Base
          </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                <h3 className="text-2xl font-normal text-agentic-text font-display pr-8 group-hover:text-agentic-primary transition-colors">
                  {faq.question}
                </h3>
                <motion.div
              ...
              <AnimatePresence initial={false}>
                {openIndex === index && (
                  ...
                  >
                    <p className="text-sm leading-loose text-agentic-text/70 font-sans pb-8 max-w-3xl">
                      {faq.answer}
                    </p>
                  </motion.div>
                )}
