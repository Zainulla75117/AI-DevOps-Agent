...
class CryptoService:
    ...
    def decrypt_payload(self, encrypted_data: str, encrypted_key: str, iv: str) -> dict:
        ...
        try:
            ...
            print(f"[CRYPTO] AES key decrypted successfully. Key length: {len(aes_key)} bytes ({len(aes_key)*8} bits)")
            ...
            # 3. Strip PKCS7 padding (Web Crypto AES-CBC applies this automatically)
